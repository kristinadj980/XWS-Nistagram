                ...
                <template #title>
                   <b-icon icon="grid3x3-gap" aria-hidden="true"></b-icon><strong>   posts</strong>
                    ...
                    <b-card class="post_look" v-for="post in posts" v-bind:key="post.fileName">
                        ...
                        <h5 align="left"><b-icon icon="hand-thumbs-up" aria-hidden="true"></b-icon>{{post.numberOfLikes}}  likes <b-icon icon="hand-thumbs-down" aria-hidden="true"></b-icon>{{dislikesNumber}} dislikes <span style="margin-left:430px;"></span> <b-icon icon="bookmark" aria-hidden="true" align="right"></b-icon></h5>
